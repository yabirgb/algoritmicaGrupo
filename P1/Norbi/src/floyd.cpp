...
{
  double tantes;    // Valor del reloj antes de la ejecución
  double tdespues;  // Valor del reloj después de la ejecución
  ...
  cout << dim << " " << (tdespues - tantes) / CLOCKS_PER_SEC <<endl;
